...
* Файл с расширением `sed` — обычный текстовый файл, открывается вашим любимым текстовым редактором (Vim / Блокнот / Nano / Sublime / VSCode / Notepad++ / др.)

* Вывод будет показан в терминале. Если вывод слишком длинный, можно использовать команду `less` или `batcat` (она же `bat`):
